...
namespace RTS
{
    public static class ResourceManager
    {
        ...
        public static float MinCamerHeight
        {
            get { return 10; }
        }
        ...
        public static Bounds invalidBounds = new Bounds(new Vector3(-99999, -99999, -99999), new Vector3(0, 0, 0));
        ...
        public static void StoreSelectedBoxItems(GUISkin skin)
        {
            selectBoxSkin = skin;
        }
    }
